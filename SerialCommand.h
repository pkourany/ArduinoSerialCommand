...
#define commandSerial	Serial		// Select serial port where commands are received
...
#define commandSerial	Serial		// Command and serial ports same for Software Serial
